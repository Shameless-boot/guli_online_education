        ...
        FastAutoGenerator.create("jdbc:mysql:///guli?serverTimezone=GMT%2B8", "root", "123456")
                ...
                .packageConfig(builder -> {
                    builder.parent("com.shaun") // 设置父包名
                            .moduleName("cms_service") // 设置父包模块名
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("crm_banner")
                            // .addInclude("cms_teacher") // 设置需要生成的表名，可以为多个表名称，或者一个List集合
                            .addTablePrefix("cms_service_") // 设置过滤表前缀，比如cms_service_test，就只会生成为test的类名称
