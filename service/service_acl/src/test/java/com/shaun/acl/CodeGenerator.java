        ...
        FastAutoGenerator.create("jdbc:mysql:///guli?serverTimezone=GMT%2B8", "root", "123456")
                ...
                .packageConfig(builder -> {
                    builder.parent("com.shaun") // 设置父包名
                            .moduleName("service_acl") // 设置父包模块名
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("acl_user_role", "acl_role", "acl_role_permission", "acl_user", "acl_permission")
                    //         builder.addInclude("edu_comment") // 设置需要生成的表名，可以为多个表名称，或者一个List集合
                            .addTablePrefix("acl_") // 设置过滤表前缀，比如edu_service_test，就只会生成为test的类名称
